...
try:
    ...
    logger.info("Please ensure you're running this script from the DeerFlow root directory")
    exit(1)
...
async def demo_performance_comparison():
    ...
    return {
        ...
        'improvement_percentage': improvement if standard_time and optimized_time else None
    }
