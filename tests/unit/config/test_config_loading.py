...
class TestConfigLoading:
    ...
    def test_config_loading_consistency(self):
        ...
        settings2 = self.config_loader.get_settings()  # Use get_settings for cached access
        ...
        if expected_key in config_data:
            ...
            if expected_key == "agents":
                ...
                if 'max_search_results' in value:
                    assert isinstance(value['max_search_results'], int) and value['max_search_results'] > 0
