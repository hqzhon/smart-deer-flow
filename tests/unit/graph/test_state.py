...
class TestStateCustomValues:
    ...
    def test_state_with_custom_observations(self):
        ...
        state = State(messages=[], observations=observations)
    ...
    def test_state_with_plan_iterations(self):
        ...
        state = State(messages=[], plan_iterations=5)
    ...
    def test_state_with_current_plan(self):
        ...
        state = State(messages=[], current_plan=self.test_plan)
    ...
    def test_state_with_final_report(self):
        ...
        state = State(messages=[], final_report=report)
    ...
    def test_state_with_auto_accepted_plan(self):
        ...
        state = State(messages=[], auto_accepted_plan=True)
    ...
    def test_state_with_background_investigation_disabled(self):
        ...
        state = State(messages=[], enable_background_investigation=False)
    ...
    def test_state_with_background_investigation_results(self):
        ...
        state = State(messages=[], background_investigation_results=results)
...
class TestStateOperations:
    ...
    def test_state_key_access(self):
        ...
        state = State(messages=[], locale="en-US", plan_iterations=1)
    ...
    def test_state_iteration(self):
        ...
        state = State(messages=[], locale="en-US", plan_iterations=2)
...
class TestStateEdgeCases:
    ...
    def test_state_with_none_values(self):
        ...
        state = State(
            messages=[], current_plan=None, background_investigation_results=None
        )
    ...
    def test_state_with_empty_collections(self):
        ...
        state = State(messages=[], observations=[], final_report="")
    ...
    def test_state_with_complex_plan(self):
        ...
        state = State(messages=[], current_plan=complex_plan)
...
class TestStatePerformance:
    ...
    def test_state_access_performance(self):
        ...
        state = State(
            messages=[], locale="en-US", observations=["obs1", "obs2", "obs3"]
        )
