...
class DependencyInjectionContainer:
    ...
    def register_transient(
        ...
        return self._register_service(
            service_type, implementation_type, factory, None, LifecycleScope.TRANSIENT
        )
    ...
    def register_scoped(
        ...
        return self._register_service(
            service_type, implementation_type, factory, None, LifecycleScope.SCOPED
        )
    ...
    def _resolve_dependencies(self, dependencies: Dict[str, Type]) -> Dict[str, Any]:
        ...
        for param_name, param_type in dependencies.items():
            try:
                ...
                logger.warning(
                    f"Failed to resolve dependency {param_name} of type {param_type.__name__}: {e}"
                )
...
def configure_services(
    configuration_func: Callable[[DependencyInjectionContainer], None],
):
    """Configure services"""
