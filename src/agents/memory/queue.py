...
class MemoryUpdateQueue:
    ...
    def add(self, thread_id: str, messages: list[Any]) -> None:
        ...
        print(
            f"Memory update queued for thread {thread_id}, queue size: {len(self._queue)}"
        )
        ...
        try:
            ...
            for context in contexts_to_process:
                try:
                    ...
                    if success:
                        print(
                            f"Memory updated successfully for thread {context.thread_id}"
                        )
                    else:
                        print(
                            f"Memory update skipped/failed for thread {context.thread_id}"
                        )
