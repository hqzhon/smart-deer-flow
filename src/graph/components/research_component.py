...
def research_step(state: AgentState, research_agent, tools: List, config: ResearchConfig) -> Dict[str, Any]:
...
def process_research_findings(findings: List, search_results: List, config: ResearchConfig) -> List:
