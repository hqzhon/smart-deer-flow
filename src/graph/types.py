...
class ReflectionState(BaseModel):
    ...
    integration_active: bool = Field(default=False, description="Whether reflection integration is active")
    
    # Session management
    current_session: Optional[str] = Field(default=None, description="Current reflection session ID")
    triggered: bool = Field(default=False, description="Whether reflection has been triggered")
    last_step: int = Field(default=0, description="Last step where reflection was executed")
    
    # Reflection results and analysis
    results: List[Dict[str, Any]] = Field(default_factory=list, description="Historical reflection results")
    comprehensive_report: str = Field(default="", description="Comprehensive research report synthesizing all findings")
    ...
    # Assessment metrics
    sufficiency_score: float = Field(default=0.0, description="Research sufficiency score")
