...
class SandboxNotFoundError(SandboxError):
    ...
    def __init__(
        self, message: str = "Sandbox not found", sandbox_id: str | None = None
    ):
...
class SandboxTimeoutError(SandboxError):
    ...
    def __init__(
        self, message: str = "Sandbox operation timed out", timeout: float | None = None
    ):
...
class SandboxCreationError(SandboxError):
    ...
    def __init__(
        self, message: str = "Failed to create sandbox", reason: str | None = None
    ):
