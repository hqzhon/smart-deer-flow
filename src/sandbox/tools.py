...
def ensure_thread_directories_exist(
    runtime: ToolRuntime[ContextT, ThreadState] | None,
) -> None:
...
def bash_tool(
    runtime: ToolRuntime[ContextT, ThreadState], description: str, command: str
) -> str:
...
def ls_tool(
    runtime: ToolRuntime[ContextT, ThreadState], description: str, path: str
) -> str:
