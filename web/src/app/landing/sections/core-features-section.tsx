...
const features = [
  {
    ...
    href: "https://github.com/hqzhon/smart-deer-flow/blob/main/src/tools",
    cta: "Learn more",
    background: (
  ...
  },
  {
    ...
    href: "https://github.com/hqzhon/smart-deer-flow/blob/main/src/graph/nodes.py",
    cta: "Learn more",
    background: (
      <img alt="background" className="absolute -top-20 -right-20 opacity-60" />
    ),
  ...
  },
  {
    ...
    href: "https://github.com/hqzhon/smart-deer-flow/blob/main/src/podcast",
    cta: "Learn more",
    background: (
      <img alt="background" className="absolute -top-20 -right-20 opacity-60" />
    ),
